...
<div class="login-container">
    <!-- Logo e branding (opcional, mas mantém a consistência do design) -->
    ...
    <div class="form-section">
        <div class="form-container">
            <div class="form-header">
                ...
                <p>Informe seu e-mail para redefinir a palavra-passe</p>
            </div>
            ...
            <form action="{{ route("forgotPasswordEmail") }}" method="POST">
                ...
                <button type="submit" class="login-button">
                    <span class="button-text">Enviar Link de Redefinição</span>
