...
@section('content')
  <div class="row justify-content-center">
    <div class="col-md-6">
      <div class="card mt-4 shadow">
        ...
        <div class="card-body">
          <form action="{{ route('admin.vacationRequests.update', $data->id) }}" method="POST"
            ...
            <div class="row g-2 mb-3">
              <div class="col-6">
                ...
                <input type="date" name="vacationStart" id="vacationStart" class="form-control"
                  value="{{ $data->vacationStart }}" required>
              ...
              <div class="col-6">
                ...
                <input type="date" name="vacationEnd" id="vacationEnd" class="form-control"
                  value="{{ $data->vacationEnd }}" readonly required>
  ...
  @push('scripts')
    <script>
      ...
      // Auto-calculate on page load with existing values
      calcEnd();
    </script>
  @endpush
@endsection