    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">Adicionar novo Pedido de Férias</li>
            </ul>
        </div>
                ...
                <div class="card stretch stretch-full">
                    <div class="card-body lead-status">
                        <div class="mb-5 d-flex align-items-center justify-content-between">
                            ...
                            <a href="javascript:void(0);" class="btn btn-sm btn-light-brand">Pedido de férias</a>
                        </div>
                        <div class="row">
                            <form action="{{ route('admin.vacationRequests.searchEmployee') }}" method="GET"
                                class="mb-4">
                                <div class="row g-3">
                                    <div class="col-md-8">
                            ...
                            @isset($employee)
                                ...
                                <form method="POST" action="{{ route('admin.vacationRequests.store') }}"
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div id="holidaysContainer">
                                                <div class="holiday-field d-flex mb-2">
                                                    <input type="date" name="manualHolidays[]"
                                                        class="form-control holiday-input">
                                                    <button type="button"
                                                        class="btn btn-outline-danger btn-sm ms-2 remove-holiday">–</button>
                                                </div>
                                            </div>
                                            <button type="button" id="addHoliday" class="btn btn-outline-secondary btn-sm">
                                                + Adicionar Data
                                            </button>
                                            @error('manualHolidays.*')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="supportDocument" id="supportDocument"
                                            class="form-control" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx,.xlsx">
                                    </div>
