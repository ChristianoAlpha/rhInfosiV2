...
@section('content')
  <div class="card mt-4 shadow" style="margin-top: 1.5rem;">
    <div class="card-header bg-secondary text-white d-flex justify-content-between align-items-center">
      ...
      <a href="{{ route('admin.vacationRequests.index') }}" class="btn btn-outline-light btn-sm">
        <i class="fas fa-arrow-left"></i> Voltar
      </a>
    </div>
    <div class="card-body">
      <form action="{{ route('admin.vacationRequests.searchEmployee') }}" method="GET" class="mb-4">
        <div class="row g-3">
          <div class="col-md-8">
            <div class="form-floating">
              <input type="text" name="employeeSearch" id="employeeSearch" class="form-control" placeholder=""
      ...
      @isset($employee)
        ...
        <form method="POST" action="{{ route('admin.vacationRequests.store') }}" enctype="multipart/form-data">
          @csrf
