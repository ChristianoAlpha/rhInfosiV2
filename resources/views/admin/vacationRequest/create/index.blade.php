  ...
  <div class="row justify-content-center">
    <div class="{{ isset($employee) ? 'col-md-6' : 'col-md-8' }}">
      <div class="card mt-4 shadow">
        ...
        <div class="card-body">
          @if(!isset($employee))
            <form action="{{ route('admin.vacationRequests.searchEmployee') }}" method="GET" class="mb-3">
              <div class="row g-2">
                <div class="col-8">
          ...
          @else
            ...
            <form action="{{ route('admin.vacationRequests.store') }}" method="POST" enctype="multipart/form-data">
              @csrf
