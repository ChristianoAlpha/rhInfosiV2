                  ...
                  <tr class="border-bottom">
                    <td class="ps-4 py-3">
                      <div class="d-flex align-items-center">
                        @if($emp->photo)
                          <img src="{{ asset('frontend/images/departments/' . $emp->photo) }}" alt="{{ $emp->fullName }}"
                    ...
                    <td class="text-center">
                      <div class="btn-group" role="group">
                        <a href="{{ route('dh.downloadEmployeeVacationPdf', $emp->id) }}"
                          class="btn btn-outline-primary btn-sm rounded-start" title="PDF de Férias" target="_blank">
                          <i class="fas fa-umbrella-beach me-1"></i>Férias
                        </a>
                        <a href="{{ route('dh.downloadEmployeeLeavePdf', $emp->id) }}"
                          class="btn btn-outline-secondary btn-sm rounded-end" title="PDF de Licença" target="_blank">
