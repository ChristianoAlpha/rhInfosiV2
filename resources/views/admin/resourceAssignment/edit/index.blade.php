                ...
                <div class="card stretch stretch-full">
                    <div class="card-body lead-status">
                        ...
                        <div class="row">
                            ...
                            <form method="POST"
                                action="{{ route('admin.resourceAssignments.update', $resourceAssignment->id) }}">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-6">
                                        <div class="form-floating">
                                            <input type="date" name="start_date" id="start_date" class="form-control"
                                                value="{{ old('start_date', $resourceAssignment->start_date ?? '') }}"
                                                required>
                                    ...
                                    <div class="col-6">
                                        <div class="form-floating">
                                            <input type="date" name="end_date" id="end_date" class="form-control"
                                                value="{{ old('end_date', $resourceAssignment->end_date ?? '') }}"
                                                required>
