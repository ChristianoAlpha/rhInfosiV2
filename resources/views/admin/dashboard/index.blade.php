    ...
    <div class="container-fluid px-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="pt-4">
                                <div class="d-flex align-items-center justify-content-between">
                                    <a href="{{ route('admin.employeee.index') }}"
                            ...
                            <div class="d-flex align-items-start justify-content-between mb-4">
                                <div class="d-flex gap-4 align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h3 class="fs-13 fw-semibold "> Funcionários Activos</h3>
                                    </div>
                                </div>
                                <a href="{{ route('admin.employeee.filterByStatus', ['status' => 'active']) }}"
                                    class="">
                                    <i data-feather="more-vertical"></i>
                                </a>
                            </div>
                            <div class="pt-4">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="w-100 text-end">
                                        ...
                                        <span
                                            class="fs-11 text-muted">({{ $totalEmployees > 0 ? round(($activeEmployees / $totalEmployees) * 100) : 0 }}%)</span>
                                    </div>
                                </div>
                                <div class="progress mt-2 ht-3">
                                    <div class="progress-bar bg-success" role="progressbar"
                                        style="width: {{ $totalEmployees > 0 ? round(($activeEmployees / $totalEmployees) * 100) : 0 }}%">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="pt-4">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="w-100 text-end">
                                        ...
                                        <span
                                            class="fs-11 text-muted">({{ $totalEmployees > 0 ? round(($highlightedEmployees / $totalEmployees) * 100) : 0 }}%)</span>
                                    </div>
                                </div>
                                <div class="progress mt-2 ht-3">
                                    <div class="progress-bar bg-warning" role="progressbar"
                                        style="width: {{ $totalEmployees > 0 ? round(($highlightedEmployees / $totalEmployees) * 100) : 0 }}%">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xxl-3 col-md-6">
                    <div class="card stretch stretch-full">
                        <div class="card-body">
                            ...
                            <div class="pt-4">
                                <div class="d-flex align-items-center justify-content-between">
                                    <a href="{{ route('admin.retirements.index') }}"
                                        class="fs-12 fw-medium text-muted text-truncate-1-line">Ver Detalhes</a>
                                    <div class="w-100 text-end">
                                        <span class="fs-12 text-dark">{{ $retiredEmployees }}</span>
                                        <span
                                            class="fs-11 text-muted">({{ $totalEmployees > 0 ? round(($retiredEmployees / $totalEmployees) * 100) : 0 }}%)</span>
                                    </div>
                                </div>
                                <div class="progress mt-2 ht-3">
                                    <div class="progress-bar bg-danger" role="progressbar"
                                        style="width: {{ $totalEmployees > 0 ? round(($retiredEmployees / $totalEmployees) * 100) : 0 }}%">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card stretch stretch-full">
                        <div class="card-body">
                            <div class="d-flex align-items-start justify-content-between mb-4">
                                ...
                                <a href="{{ route('admin.interns.index') }}" class="">
                                    <i data-feather="more-vertical"></i>
                                </a>
                            </div>
                            <div class="pt-4">
                                ...
                                <div class="progress mt-2 ht-3">
                                    <div class="progress-bar bg-info" role="progressbar"
                                        style="width: {{ $totalInterns > 0 ? 100 : 0 }}%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-header-action">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="{{ route('admin.employeee.index') }}" class="dropdown-item"><i
                                                data-feather="users"></i>Ver todos</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ $head->photo ? asset('frontend/images/departments/' . $head->photo) : asset('public/assets/images/avatar/default.png') }}"
                                                                alt="{{ $head->fullName ?? 'Sem Nome' }}"
                                                                class="img-fluid" />
                                                        </div>
                                                        <a href="{{ route('admin.employeee.show', $head->id) }}">
                                                            <span
                                                                class="d-block">{{ $head->fullName ?? 'Sem Nome' }}</span>
                                                            <span
                                                                class="fs-12 d-block fw-normal text-muted">{{ $head->email ?? 'Sem Email' }}</span>
                                                        </a>
                                                    </div>
                                                </td>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="3" class="text-center">Nenhum chefe de departamento
                                                    encontrado.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                    ...
                                    <div class="card-body border border-dashed border-gray-5 rounded-3 position-relative">
                                        <div class="hstack justify-content-between gap-4">
                                            <div>
                                                ...
                                                <div class="fs-12 text-muted"><span
                                                        class="text-dark fw-medium">Total:</span> {{ $contractEmployees }}
                                                </div>
                                            </div>
        ...
        @else
            <div class="alert alert-info">
                ...
                <strong>Atenção: </strong>Você tem acesso aos menus gerais do sistema, porém não pode visualizar os dados
                estatísticos do Painel de Controle.
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                try {
                    ...
                    var calculated = Math.max(baseHeight, Math.min(1200, categoryData.length * rowHeight +
                    120)); // limitado entre base e 1200
                    var chartHeight = calculated;

                    // ---------- preparar arrays ----------
                    var categories = categoryData.map(function(c) {
                        return c.name;
                    });
                    var values = categoryData.map(function(c) {
                        return c.count;
                    });

                    // Gera paleta repetida
                    var palette = ['#3454D1', '#4F46E5', '#06B6D4', '#10B981', '#F59E0B', '#F97316', '#EF4444',
                        '#8B5CF6', '#06A7E1'
                    ];
                    var colors = categories.map(function(_, i) {
                    ...
                    var options = {
                        ...
                        tooltip: {
                            ...
                            y: {
                                formatter: function(val) {
                                    return val + " funcionário" + (val !== 1 ? "s" : "");
                                }
                            }
                        },
                        colors: colors,
                        ...
                        responsive: [{
                            ...
                            options: {
                                ...
                                chart: {
                                    height: Math.max(280, Math.min(800, categoryData.length * 22 + 80))
                                },
                                xaxis: {
                                    labels: {
                                        rotate: -30
                    ...
                    if (!el) {
                        console.warn('#allCategoriesChart não encontrado');
                        return;
                    }
