...
@section('content')
    ...
    {{--     <div class="card mt-4 shadow">
        <div class="card-header bg-secondary text-white d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('admin.leaveRequests.pdfAll') }}" class="btn btn-outline-light btn-sm" title="Baixar PDF"
                ...
                @if (request()->filled('startDate') || request()->filled('endDate') || (request()->filled('status') && request('status') !== 'Todos'))
                    <a href="{{ route('admin.leaveRequests.pdfAll') }}?{{ http_build_query(request()->only(['startDate', 'endDate', 'status'])) }}"
                ...
                <a href="{{ route('admin.leaveRequests.create') }}" class="btn btn-outline-light btn-sm">
    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">Todos os Pedidos de Licença</li>
            </ul>
        </div>
        <div class="page-header-right ms-auto">
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    <a href="{{ route('admin.leaveRequests.pdfAll') }}" class="btn btn-outline-secondary"
                    ...
                    @endif
                    <a href="{{ route('admin.leaveRequests.create') }}" class="btn btn-outline-secondary">
                ...
                <div class="card stretch stretch-full">
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <form method="GET" action="{{ route('admin.leaveRequests.index') }}" class="row g-3 mb-4">
                                <div class="col-md-3">
                                    ...
                                    <div class="form-floating">
                                        <select name="status" class="form-select">
                                            ...
                                            <option value="Aprovado"
                                                {{ request('status') === 'Aprovado' ? 'selected' : '' }}>Aprovado
                                            </option>
                                            <option value="Recusado"
                                                {{ request('status') === 'Recusado' ? 'selected' : '' }}>Recusado
                                            </option>
                            ...
                            <table id="leadList" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9" class="text-center">Nenhum pedido de licença listado.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
