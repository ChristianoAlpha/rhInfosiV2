    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">Todos os Reformados</li>
            </ul>
        </div>
            ...
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                    ...
                    @if (
                        ...
                        <a href="{{ route('admin.retirements.pdf') }}" class="btn btn-outline-secondary" target="_blank"
                            rel="noopener noreferrer">
                            <i class="fas fa-file-earmark-pdf"></i> Baixar PDF (Todos)
                        </a>
                    @endif
                    ...
                    @endif
                    <a href="{{ route('admin.retirements.create') }}" class="btn btn-outline-secondary">
