    ...
    <div class="header-btn restricted-desktop">
        <div id="restricted-area-container" style="position: relative; display: inline-block;">
            <a id="restricted-area-link"
                ...
                <i class="fa fa-user"
                    style="color: #f27602; font-size: 20px; padding: 8px; border: 2px solid #f27602; border-radius: 50%;"></i>
            </a>
            <div id="restricted-tooltip"
                style="
            display: none;
            position: absolute;
            top: calc(100% + 5px);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        menuLinks.forEach(function(link) {
            link.addEventListener('click', function(e) {
                ...
                if (menu.classList.contains('active') && !parentLi.classList.contains(
                        'has-submenu')) {
