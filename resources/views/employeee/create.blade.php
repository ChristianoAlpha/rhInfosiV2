                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <select name="gender" id="gender" class="form-select">
                            <option value="" selected>Selecione</option>
                            <option value="Masculino" @if (old('gender') == 'Masculino') selected @endif>
                                Masculino</option>
                            <option value="Feminino" @if (old('gender') == 'Feminino') selected @endif>
                                Feminino</option>
                        </select>
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <ul class="dropdown-menu" id="phone_code_menu"
                                    style="max-height: 30em; overflow-y: auto;"></ul>
                                <div class="form-floating">
                                    <input type="text" name="mobile" id="mobile" class="form-control"
                                        placeholder="" maxlength="16" value="{{ old('mobile') }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="iban" id="iban" class="form-control"
                                    placeholder="IBAN" value="AO06{{ old('iban') ? substr(old('iban'), 4) : '' }}"
                                    maxlength="25" pattern="AO06[0-9]{21}"
